...
```{r, t_summary_dist4_setup, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r, t_summary_dist4_ts1, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = {{plot_height}}}
p_long_x_lat_ts1 <- get_loc_by_timespan(ts_lst, "{{time_span1}}") %>%
  create_region_scatter("Time span: {{time_span1}}", lat_range, lon_range)

print(p_long_x_lat_ts1)

```

#### {{time_span2}}

```{r, t_summary_dist4_ts2, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = {{plot_height}}}
p_long_x_lat_ts2 <- get_loc_by_timespan(ts_lst, "{{time_span2}}") %>%
  create_region_scatter("Time span: {{time_span2}}", lat_range, lon_range)

print(p_long_x_lat_ts2)

```

#### {{time_span3}}

```{r, t_summary_dist4_ts3, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = {{plot_height}}}
p_long_x_lat_ts3 <- get_loc_by_timespan(ts_lst, "{{time_span3}}") %>%
  create_region_scatter("Time span: {{time_span3}}", lat_range, lon_range)

print(p_long_x_lat_ts3)

```

#### {{time_span4}}

```{r, t_summary_dist4_ts4, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = {{plot_height}}}
p_long_x_lat_ts4 <- get_loc_by_timespan(ts_lst, "{{time_span4}}") %>%
  create_region_scatter("Time span: {{time_span4}}", lat_range, lon_range)

print(p_long_x_lat_ts4)
