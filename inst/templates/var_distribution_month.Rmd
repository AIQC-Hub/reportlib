...
```{r, t_var_dist_month_qc1, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 10}
...
```{r, t_var_dist_month_qc4, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 10}

if (nrow(df_month_qc4) > 0) {
...
```{r, t_var_dist_month_all, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 10}
